...
@if(Session::has('message'))
    ...
    <div class="card">
        <div class="card-header">Form tambah data barang baru</div>
        <div class="card-body">
            <form action="{{ route('items.store') }}" method="POST">
                @csrf
                <div class="form-group">
                    <label for="kd_brg">Kode Barang</label>
                    <input type="text" name="kd_brg" id="kd_brg" class="form-control @error('kd_brg') is-invalid @enderror" value="{{ old('kd_brg') }}" autocomplete="off">
                </div>
                @error('kd_brg')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nm_brg" id="nm_brg" class="form-control @error('nm_brg') is-invalid @enderror" autocomplete="off" value="{{ old('nm_brg') }}">
                </div>
                @error('nm_brg')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
                <div class="form-group">
                    ...
                    <input type="text" name="hrg_beli" id="hrg_beli" class="form-control @error('hrg_beli') is-invalid @enderror" autocomplete="off" value="{{ old('hrg_beli') }}">
                </div>
                @error('hrg_beli')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
                <div class="form-group">
                    ...
                    <input type="text" name="hrg_jual" id="hrg_jual" class="form-control @error('hrg_jual') is-invalid @enderror" value="{{ old('hrg_jual') }}">
                </div>
                @error('hrg_jual')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
                <div class="form-group">
                    ...
                    <input type="text" name="jml_brg" id="jml_brg" class="form-control @error('jml_brg') is-invalid @enderror" value="{{ old('jml_brg') }}">
                </div>
                @error('jml_brg')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
