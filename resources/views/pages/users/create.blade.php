        ...
        <div class="card-body">
            <form action="{{ route('users.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="kd_ptg" id="kd_ptg" class="form-control @error('kd_ptg') is-invalid @enderror" value="{{ old('kd_ptg') }}" autocomplete="off">
                </div>
                @error('kd_ptg')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nm_ptg" id="nm_ptg" class="form-control @error('nm_ptg') is-invalid @enderror" autocomplete="off" value="{{ old('nm_ptg') }}">
                </div>
                @error('nm_ptg')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
                <div class="form-group">
                    ...
                    <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" autocomplete="off" value="{{ old('email') }}">
                </div>
                @error('email')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
